...
public class ViewStudentInformation_UI
{
	...
	private ViewStudentController vsc = new ViewStudentController();
	...
	{
		for(int x = 0; x < ViewStudentController.getStudentCollectionSize(); x++)
		{
			buttonlist.add(new JButton(ViewStudentController.getStudent(x).getStudentName()));
			
			/************************************************
			 * You have the UI directly accessing the boundary
			 * class.
			 */
			/*
			 * fixed
		...
		WestPanel.setLayout(new GridLayout(ViewStudentController.getStudentCollectionSize(), 1));
		...
		public void actionPerformed (ActionEvent event)
  		{
			...
			for(int x = 0; x < ViewStudentController.getStudentCollectionSize(); x++)
			{
				...
				if( event.getSource() == buttonlist.get(x) )
				{
					...
					Output2.setText(ViewStudentController.ViewStudent(x));
