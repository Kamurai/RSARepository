...
import version4.ManageStudentInformation_Controller;
...
public class ManageStudentInformation_UI
{
	...
	public ManageStudentInformation_UI()
	{
		...
		{
			buttonlist.add(new JButton(StudentInfoManager.getStudent(x).getStudentName()));
		}
		...
		WestPanel.setLayout(new GridLayout(StudentInfoManager.getSize(), 1));
	...
	private class UpdateStudentListener implements ActionListener
	{
		public void actionPerformed (ActionEvent event)
		{
			...
			ManageStudentController.UpdateStudent(inputlist, Output2.getText());
	...
	private class StudentListener implements ActionListener
	{
		public void actionPerformed (ActionEvent event)
  		{
			ManageStudentController.ViewStudent(frame, CenterPanel, buttonlist, inputlist, Output2, event);
	...
	private class MainMenuListener implements ActionListener
	{
		public void actionPerformed (ActionEvent event)
  		{
			//Load Main Menu
			ManageStudentController.LoadMainMenu();
